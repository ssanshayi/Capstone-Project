...
export const marineSpeciesData: MarineSpecies[] = [
  ...
  },
  {
    ...
    iconUrl: "/placeholder.svg?height=40&width=40",
    imageUrl: "/Great White Shark.png",
    description:
